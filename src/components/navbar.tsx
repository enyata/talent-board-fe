...
const Navbar = async () => {
  ...
  return (
    <>
      <nav className="fixed top-0 bg-white/50  backdrop-blur-lg left-0 right-0 z-50 p-6 text-foreground transition-all will-change-transform hidden md:block">
          ...
          {user ? (
            ...
            <div>
              <Link href="/signup">
                <Button
                  variant="outline"
                  className="w-[72px] h-[42px] cursor-pointer"
                >
                  Register
                </Button>
              </Link>
