        ...
        <div className="px-[16px] ">
          <div className="flex justify-between items-center">
            <div className="text-[#475467] text-[14px]">
              ...
              <p>
                You have {notifications.length} unread messages from recruiters
              </p>
            </div>
          ...
          <div className="flex flex-col gap-[12px] mt-[24px]">
            {notifications && notifications?.length === 0 ? (
              ...
              notifications.map((item: NotificationData) => (
                <Card
                  key={item.id}
                  className="relative w-full text-[#727272] gap-0 text-[14px] p-[16px] bg-white shadow-none"
                >
                      ...
                      <div>
                        <div className="flex flex-row gap-2 justify-between md:items-center">
                          <div className="flex gap-2 items-center w-full">
                            ...
                            <div>
                              <p className="font-semibold text-[14px] text-[#5F5F5F]">
