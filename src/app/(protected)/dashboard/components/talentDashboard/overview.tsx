        ...
        <div className="px-[16px]">
          <div className="flex flex-col md:flex-row justify-between md:items-center">
            <div className="flex items-center gap-2">
              <Avatar className="size-[64px] border-[2px] border-[#E0E0E0]">
                ...
                <AvatarFallback>
                  {user ? user.first_name.trim().charAt(0).toUpperCase() : ""}
                </AvatarFallback>
              </Avatar>
              <div className="text-[#3A374B] flex flex-col">
                ...
                <span className="text-[14px] font-medium text-[#475467]">
                  <span className="capitalize">{getTimeOfDay()}</span> is here!
          ...
          <div className="mt-4 flex flex-col md:flex-row justify-between items-center gap-4">
            {overviewCardDetails.map((card, index) => (
              <div
                key={index}
                className="text-[14px] font-semibold flex flex-row w-full justify-between items-center text-[#727272] bg-white rounded-lg border-[1px] p-5"
              >
                ...
                <span className="text-[#09090B] text-[20px] font-bold">
                  {card.number}
                </span>
              </div>
            ))}
