          ...
          <div className="max-w-[901px] w-full font-semibold">
            <div className="md:text-[40px] text-3xl">
              <p className="leading-[120%]">
                Handpicked Professionals. Ready to Build{" "}
              </p>
              <p className="leading-[120%]">What’s Next.</p>
            </div>
            <p className="text-[17px] mt-[24px]">
              Meet a few of the standout talents from our board — vetted,
              verified, and open to new opportunities.
            </p>
          </div>
        </div>
        <div className="mt-[64px]">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <Link href={"/talents"} className="">
              <Button
                variant={"outline"}
                className="w-[149px] h-[36px] cursor-pointer"
              >
                View all Talents{" "}
                <span className="">
          ...
          {!talents ? (
            <div className="flex flex-col items-center justify-center gap-2 p-12 text-center min-h-[400px]">
              <CloudOff className="size-6 text-muted-foreground/50" />
              <div className="text-[12.5px] font-medium">
                Something went wrong
              </div>
              <p className="text-xs text-muted-foreground">
                Could not fetch top talents, try again in few minutes.
              </p>
            </div>
          ) : (
