...
export const StatCard: React.FC<StatCardProps> = ({ img, icon, stat, desc, bg, reverse }) => {
    return (
        <Card className={`w-[394px] h-[480px] p-[20px] ${reverse ? 'pt-[36px]' : 'pb-[36px]'} ${bg} flex ${reverse ? 'flex-col-reverse' : 'flex-col'} justify-between`}>
            <Image
                src={img}
                alt={"stateImage"}
                width={394}
            ...
            <div className="flex items-center justify-between">
                <div className={`flex flex-col ${reverse ? 'text-black' : 'text-white'} font-semibold`}>
