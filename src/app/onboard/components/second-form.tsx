      ...
      <div className="flex flex-col gap-[36px] mt-[36px] text-[14px] font-normal">
        ...
        <div className="flex flex-col md:flex-row gap-[24px] justify-between">
          ...
          <div className="w-full">
            ...
            />
            {touchedFields?.data?.country &&
              errors?.data &&
              "country" in errors.data && (
          ...
          <div className="w-full">
            ...
            />
            {touchedFields?.data?.state &&
              errors?.data &&
              "state" in errors.data && (
                <p className="text-sm text-red-500 mt-1">
        ...
        {role === "recruiter" && (
          <div className="w-full">
            <Label htmlFor="work-email" className="font-normal">
              Work Email*
            </Label>
            <Input
              id="work-email"
            ...
            />
            {touchedFields?.data?.work_email &&
              errors?.data &&
              "work_email" in errors.data && (
                <p className="text-sm text-red-500 mt-1">
        ...
        {role === "talent" && (
          <div className="w-full">
            <Label htmlFor="job_title" className="font-normal">
              Professional Title*
            </Label>
            <Input
              id="job_title"
            ...
            />
            {touchedFields?.data?.job_title &&
              errors?.data &&
              "job_title" in errors.data && (
                <p className="text-sm text-red-500 mt-1">
        ...
        {role === "talent" && (
          <div className="w-full">
            ...
            <p className="text-sm text-zinc-500 mt-1">
              You’ve used {bio.length}/250 characters.
            </p>
            {touchedFields?.data?.bio &&
              errors?.data &&
              "bio" in errors.data && (
                <p className="text-sm text-red-500 mt-1">
        ...
        {role === "talent" && (
          <div className="w-full">
            ...
            />
            {touchedFields?.data?.portfolio &&
              errors?.data &&
              "portfolio" in errors.data && (
                <p className="text-sm text-red-500 mt-1">
        ...
        <div className="w-full">
          ...
          {touchedFields?.data?.linkedin &&
            errors?.data &&
            "linkedin" in errors.data && (
              <p className="text-sm text-red-500 mt-1">
